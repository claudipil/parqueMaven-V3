...
public class AtraccionDAO {
	...
	public static int insert(Atraccion atraccion) throws SQLException {
		String sql = "INSERT INTO atracciones (id_usuario, id_atraccion, id_promocion) VALUES (?, ?, ?)";
	...
	public static int update(Atraccion atraccion) throws SQLException {
		String sql = "UPDATE atracciones SET id = ? WHERE id = ?";
		Connection conn = ConnectionProvider.getConnection();
